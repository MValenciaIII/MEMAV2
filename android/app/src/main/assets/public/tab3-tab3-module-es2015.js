    ...
    switch (type) {
      ...
      case "Polygon":
        for (
          ...
          if (
            callback(
              Object(_turf_helpers__WEBPACK_IMPORTED_MODULE_0__["lineString"])(coords[geometryIndex], feature.properties),
              featureIndex,
              multiFeatureIndex,
              geometryIndex
            ) === false
...
let Tab3Page = class Tab3Page {
    ...
    onMapReady(map) {
        ...
        this.getLocationService().then(resp => {
            this.map.setView(leaflet__WEBPACK_IMPORTED_MODULE_3__["latLng"](resp.lat, resp.lng), 18);
        });
    ...
    geoRadius(value) {
        ...
        this.getLocationService().then(resp => {
            ...
            if (this.rangeId === undefined) {
                this.geoRadiusLine = leaflet__WEBPACK_IMPORTED_MODULE_3__["circle"]([resp.lat, resp.lng], { radius: 200 }).addTo(this.map);
            }
                ...
                for (let i = 0; i < this.polygons.length; i++) {
                    ...
                    let doesIntersect = Object(_turf_boolean_intersects__WEBPACK_IMPORTED_MODULE_4__["default"])(this.polygons[i].geometry, this.turfcircle.geometry);
    ...
    getAlerts() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let poly = [];
            let turfCircle;
            let response = this.http.get("https://api.weather.gov/alerts/active?area=LA").subscribe((json) => {
                console.log(json);
                this.json = json;
