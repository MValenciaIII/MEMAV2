...
/* harmony import */ var proj4leaflet__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! proj4leaflet */ "./node_modules/proj4leaflet/src/proj4leaflet.js");
/* harmony import */ var proj4leaflet__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(proj4leaflet__WEBPACK_IMPORTED_MODULE_6__);
...
let Tab3Page = class Tab3Page {
    constructor(http, nativeGeocoder) {
        this.http = http;
    ...
    onMapReady(map) {
        ...
        this.getLocationService().then(resp => {
            this.map.setView(leaflet__WEBPACK_IMPORTED_MODULE_3__["latLng"](resp.lat, resp.lng), 10);
        });
    ...
    initializeMapOptions() {
        this.mapOptions = {
            layers: [
                Object(leaflet__WEBPACK_IMPORTED_MODULE_3__["tileLayer"])('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                    maxZoom: 18,
        ...
        for (let i = 0; i < this.CountyPoints.length; i++) {
            ...
            if (element.properties.CONAME == this.countySelection) {
                if (this.geoRadiusLine === undefined) {
                    this.geoRadiusLine = leaflet__WEBPACK_IMPORTED_MODULE_3__["circle"]([element.properties.Lat, element.properties.Lon], { radius: 16900 }).addTo(this.map);
    ...
    addSampleMarker() {
        this.getLocationService().then(resp => {
            const marker = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Marker"]([resp.lat, resp.lng])
                .setIcon(Object(leaflet__WEBPACK_IMPORTED_MODULE_3__["icon"])({
                iconSize: [25, 41],
                iconAnchor: [13, 41],
    ...
    getAlerts() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let poly = [];
            let response = this.http.get("https://api.weather.gov/alerts/active?area=MS").subscribe((json) => {
                console.log(json);
                this.json = json;
                if (this.json.features) {
                    for (let i = 0; i < this.json.features.length; i++) {
                        ...
                        //
                        var pressOne = leaflet__WEBPACK_IMPORTED_MODULE_3__["geoJSON"](element).addTo(this.map);
    ...
    setCountiesPoints() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            let countiesPoints = this.http.get('../../assets/MississippiCountiesPointsWGS84.geojson').subscribe((json) => {
                console.log(json);
                this.json = json;
                for (let i = 0; i < this.json.features.length; i++) {
                    const element = this.json.features[i];
                    ...
                    var countiesList = leaflet__WEBPACK_IMPORTED_MODULE_3__["geoJSON"](element).addTo(this.map);
...
Tab3Page.propDecorators = {
    tab3Page: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['ranger',] }]
};
