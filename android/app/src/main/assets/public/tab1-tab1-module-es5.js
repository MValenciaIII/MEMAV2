(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var Tab1Page = /*#__PURE__*/function () {
        ...
        _createClass(Tab1Page, [{
          ...
          value: function ngOnInit() {
            ...
            _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_2__["PushNotifications"].requestPermissions().then(function (result) {
            ...
            _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_2__["PushNotifications"].addListener('registration', function (token) {
              alert('Push registration success, token: ' + token.value);
            }); // Some issue with our setup and push will not work


            _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_2__["PushNotifications"].addListener('registrationError', function (error) {
              alert('Error on registration: ' + JSON.stringify(error));
            }); // Show us the notification payload if the app is open on our device


            _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_2__["PushNotifications"].addListener('pushNotificationReceived', function (notification) {
              alert('Push received: ' + JSON.stringify(notification));
            }); // Method called when tapping on a notification


            _capacitor_push_notifications__WEBPACK_IMPORTED_MODULE_2__["PushNotifications"].addListener('pushNotificationActionPerformed', function (notification) {
